      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="navbar-brand-wrapper d-flex align-items-center">
          <a class="navbar-brand brand-logo" href="main">
            <img src="asset/images/med1.png" alt="logo" class="logo-dark" />
          </a>
          <a class="navbar-brand brand-logo-mini" href="main"><img src="asset/images/logo-mini.svg" alt="logo" /></a>
        </div>
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="searchBar">
                <span class="menu-title">Search Drugs</span>
                <i class="icon-screen-desktop menu-icon"></i>
              </a>
            </li>
            <li class="nav-item">
        ...
        <div class="main-panel">
          <div class="content-wrapper">            
            <div class="input-group">
                <input type="text" class="form-control" placeholder="Search Drugs" aria-label="Recipient's username" aria-describedby="basic-addon2">
